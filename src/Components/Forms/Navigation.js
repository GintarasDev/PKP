        ...
        return (
            <div className="o-NavigationWrap">
                ...
                <div className={"side-nav"} >
                    ...
                    <ListItem clickHandler={this.setActive.bind(this)} itemNo={0} component={<AllBoards userId={this.state.activeUserId} clickHandler={this.setActive.bind(this)}/>} class={"list-item"} active={this.state.activeListItemId === 0} iconPath={"all_boards.svg"} text={"All"} width={"10rem"} height={"2rem"} clickHandler={this.setActive.bind(this)} />
                    <ListItem clickHandler={this.setActive.bind(this)} itemNo={1} component={<Board userId={this.state.activeUserId} boardIsPersonal={true} clickHandler={this.setActive.bind(this)}/>} class={"list-item"} active={this.state.activeListItemId === 1} iconPath={"personal.svg"} text={"Personal"} width={"10rem"} height={"2rem"} />
                    <ListItem clickHandler={this.setActive.bind(this)} itemNo={2} component={<BoardCreation userId={this.state.activeUserId} stateUpdater={this.setActive.bind(this)} />} class={"list-item"} active={this.state.activeListItemId === 2} iconPath={"new.svg"} text={"New"} width={"10rem"} height={"2rem"} />
                ...
                <div className={"currentItemSpace"}>
                    {this.homePage ? (<Board userId={this.state.activeUserId} boardId={/*todo: this.user.personalBoardId*/this.state.personalBoardId} boardIsPersonal={true} assignedUsers={"1 (personal)"} boardTitle={"Personal"} clickHandler={this.setActive.bind(this)}/>)
